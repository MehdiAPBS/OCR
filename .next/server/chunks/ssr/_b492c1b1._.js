...
const DataEditor = ({ data, onDataChange })=>{
    const handleChange = (key, newValue, isJson)=>{
        ...
        // Handle specific keys if needed, or generic approach
        const fieldKey = key;
        if (isJson) {
            try {
                updated[fieldKey] = JSON.parse(newValue); // Parse and cast
            } catch (e) {
                // If JSON is invalid during typing, store the raw string for Textarea,
                // but ideally, the schema should guide the type.
                // For simplicity, if it's meant to be an array like 'présences', and parse fails,
                // it might be better to keep it as is or handle error.
                // Storing raw string might break type if not handled carefully.
                // Let's assume for 'présences' it will be an array.
                // If it's a complex object field.
            ...
            if (typeof originalValue === 'number') {
                ...
                updated[fieldKey] = isNaN(parsedFloat) ? newValue : parsedFloat;
            } else if (typeof originalValue === 'boolean') {
                updated[fieldKey] = newValue.toLowerCase() === 'true';
            } else {
                updated[fieldKey] = newValue;
            }
        }
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Label"], {
                                    ...
                                    children: key.replace(/([A-Z])/g, ' $1').replace(/_/g, ' ').replace(/^./, (str)=>str.toUpperCase())
                                }, void 0, false, {
                                    fileName: "[project]/src/components/data-editor.tsx",
                                    lineNumber: 83,
                                    columnNumber: 19
                                }, this),
                                key === 'présences' || typeof value === 'object' && value !== null && !Array.isArray(value) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$textarea$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Textarea"], {
                                    id: key,
...
function PdfExtractorPage() {
    ...
    const handleProcessPdf = async ()=>{
        ...
        setIsLoading(true);
        setError(null);
        // Do not setExtractedData(null) here, allow previous data to show until new data or error
        // setExtractedData(null); 
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$extract$2d$data$2d$from$2d$pdf$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["extractDataFromPdf"])({
                pdfDataUri
            });
            if (result && result.jsonOutput && result.jsonOutput.trim() !== '' && result.jsonOutput.trim() !== '{}') {
                try {
                    const parsedData = JSON.parse(result.jsonOutput);
                    // console.log('Successfully parsed data in page.tsx:', JSON.stringify(parsedData, null, 2));
                    ...
                    console.error("Error parsing AI output as JSON in page.tsx:", parseError, "Raw output:", result.jsonOutput);
                    setError(`Failed to parse AI output. The AI returned malformed data. Raw snippet: ${String(result.jsonOutput).substring(0, 100)}...`);
                    toast({
                        title: "Parsing Failed",
                        description: "The data received from the AI could not be understood.",
                        variant: "destructive"
                    });
                    setExtractedData(null); // Explicitly set to null to show placeholder
                }
            } else {
                // This case implies the flow itself returned an empty/invalid string for jsonOutput,
                // which the current extractDataFromPdfFlow tries to avoid.
                const problematicOutput = result ? result.jsonOutput : "No result object from AI flow";
                console.warn("extractDataFromPdf flow returned an empty or unexpected jsonOutput. Full result object:", result, "Actual jsonOutput value received:", problematicOutput);
                setError("AI service returned an empty or improperly structured response. Please try again or check the PDF.");
                toast({
                    title: "Empty/Invalid Response",
                    description: "The AI service's response was not in the expected format.",
                    variant: "destructive"
                });
                setExtractedData(null); // Explicitly set to null
            }
        } catch (err) {
            console.error("Error during PDF processing call in page.tsx:", err);
    ...
    const handleSaveToSheet = async ()=>{
        if (!extractedData) {
            toast({
                title: "No Data",
                description: "There is no data to save to Google Sheet.",
                variant: "destructive"
            });
            return;
        }
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$save$2d$to$2d$google$2d$sheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveToGoogleSheet"])({
                extractedData
            });
            if (result.success) {
                toast({
                    title: "Saved to Google Sheet",
                    description: result.message || "Data successfully saved."
                });
            } else {
            ...
            toast({
                title: "Save Failed",
                description: err.message || "An unknown error occurred while saving to Google Sheet.",
                variant: "destructive"
            });
        } finally{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        className: "text-4xl font-bold text-center text-primary tracking-tight",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Upload a PDF, extract data using AI, edit it, and save to Google Sheets."
                    }, void 0, false, {
                        fileName: "[project]/src/app/page.tsx",
                        lineNumber: 214,
                        columnNumber: 9
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                ...
                                                disabled: isLoading || !pdfFile || isSavingToSheet,
                                    ...
                                    pdfFile && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            extractedData && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "md:text-right flex flex-col md:flex-row gap-2 items-center justify-end",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                        onClick: handleDownloadJson,
                                        disabled: !extractedData || isLoading || isSavingToSheet,
                                        variant: "outline",
                                        className: "border-primary text-primary hover:bg-primary/5 hover:text-primary min-w-[170px] transition-all duration-150 ease-in-out",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        disabled: !extractedData || isLoading || isSavingToSheet,
                                        variant: "outline",
                                        className: "border-green-500 text-green-600 hover:bg-green-500/10 hover:text-green-700 min-w-[190px] transition-all duration-150 ease-in-out",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        className: "h-[calc(100vh-280px)] min-h-[500px] rounded-xl overflow-hidden border border-border",
...
//# sourceMappingURL=_b492c1b1._.js.map